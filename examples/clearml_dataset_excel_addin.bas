Attribute VB_Name = "ClearMLDatasetExcelAddin"
Option Explicit

Private Const META_SHEET As String = "_meta"
Private Const LOG_FILENAME As String = "clearml_dataset_excel_addin.log"
Private Const ADDIN_VERSION As String = "0.1.0"
...
Private Sub RunOnWindows(ByVal cmd As String, ByVal wbDir As String)
    ...
    fullCmd = "cmd.exe /c (" & cmd & ") > " & CmdQuote(logPath) & " 2>&1"
