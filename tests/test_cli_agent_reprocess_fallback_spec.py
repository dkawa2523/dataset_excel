...
class _FakeLogger:
    ...
    def report_histogram(self, *args, **kwargs):  # type: ignore[no-untyped-def]
        return None
...
class TestCliAgentReprocessFallbackSpec(unittest.TestCase):
    def test_agent_reprocess_falls_back_to_dataset_spec(self) -> None:
