...
class TestCliAgentReprocessCloneProjectOutput(unittest.TestCase):
    def test_agent_reprocess_defaults_output_project_to_task_project(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            self.assertEqual(called.get("dataset_project"), "P_clone")
            self.assertEqual(called.get("dataset_name"), "N_base")
            self.assertIsNone(called.get("base_dataset_id"))
            self.assertEqual(called.get("spec_clearml_dataset_project"), "P_clone")
            self.assertEqual(called.get("spec_clearml_dataset_name"), "N_base")
